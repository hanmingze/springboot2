...
public class EmployeeTests {
    ...
    public void index() throws Exception {
        ...
        objs.add(new Employee(1,"John", "Smith",25, "I love to go rock climbing", Arrays.asList("sports", "music")));
        objs.add(new Employee(2,"Jane", "Smith", 32,"I like to collect rock albums", Arrays.asList("music")));
        objs.add(new Employee(3,"Douglas", "Fir", 35,"I like to build cabinets", Arrays.asList("forestry")));
